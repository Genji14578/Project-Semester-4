...
<body class="hold-transition sidebar-mini layout-fixed" onload="${msg }()">
	<div class="wrapper">
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a
					href="${pageContext.request.contextPath }/admin/invoice" class="nav-link">Home</a></li>
			...
			<ul class="navbar-nav ml-auto">
				...
				<li><a href="${pageContext.request.contextPath }/home">Return to user page</a></li>
			</ul>
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
							<li class="nav-item has-treeview menu-open"><a href="#"
								...
								<ul class="nav nav-treeview">
									<li class="nav-item"><a
										href="${pageContext.request.contextPath }/admin/invoice/show"
										class="nav-link active"> <i class="far fa-circle nav-icon"></i>
											<p>Show Invoice</p>
									</a></li>
									<li class="nav-item has-treeview"><a href="#"
										...
										<ul class="nav nav-treeview">
											<li class="nav-item"><a
												href="${pageContext.request.contextPath }/admin/invoice/sort/ASC"
												class="nav-link"> <i class="far fa-circle nav-icon"></i>
													<p>Ascending</p>
											</a></li>

											<li class="nav-item"><a
												href="${pageContext.request.contextPath }/admin/invoice/sort/DESC"
												class="nav-link"> <i class="far fa-circle nav-icon"></i>
													<p>Descending</p>
											</a></li>
										</ul></li>
